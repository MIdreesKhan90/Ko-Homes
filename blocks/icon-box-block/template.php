<?php
$icon_box_section_bg_color = get_field('bg_color');
$icon_box_section_pre_title = get_field('pre_title');
$icon_box_section_title = get_field('title');
$icon_box_section_icon_boxes = get_field('icon_boxes');
$icon_box_section_link_text = get_field('link_text');
$icon_box_section_link_url = get_field('link_url');
