<?php
$accordion_section_bg_color = get_field('bg_color');
$accordion_section_title = get_field('title');
$accordion_section_faqs = get_field('accordions');
$accordion_section_button_text = get_field('button_text');
$accordion_section_button_url = get_field('button_url');
?>
...
<section class="section accordion-section" <?php echo ($accordion_section_bg_color) ? 'style="background-color:' . $accordion_section_bg_color . '"' : '' ?> id="<?php echo slugify($accordion_section_title); ?>">
    <div class="container">
        <?php if ($accordion_section_title) { ?>
            <h2 class="section-title text-center"><?php echo $accordion_section_title ?></h2>
        <?php } ?>
