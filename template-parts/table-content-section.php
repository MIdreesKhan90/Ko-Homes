<?php
$table_content_section_pre_title = get_sub_field('pre_title');
$table_content_section_title = get_sub_field('title');
$table_content_section_description = get_sub_field('description');
$table_content_section_link_text = get_sub_field('link_text');
$table_content_section_link_url = get_sub_field('link_url');
$table_content_section_table_data = get_sub_field('table_data');
?>
