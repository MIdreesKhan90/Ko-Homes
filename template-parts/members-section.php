<?php
$member_section_pre_title = get_sub_field('pre_title');
$member_section_title = get_sub_field('title');
$member_section_description = get_sub_field('description');
$member_section_managers = get_sub_field('managers');
?>
