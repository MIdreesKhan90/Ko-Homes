<?php
$two_column_content_section_left_title = trim(get_sub_field('left_title'));
$two_column_content_section_left_list_content = get_sub_field('left_list_content');
$two_column_content_section_right_title = trim(get_sub_field('right_title'));
$two_column_content_section_right_list_content = get_sub_field('right_list_content');
?>
